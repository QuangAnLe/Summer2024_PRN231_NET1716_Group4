        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<bool>(type: "bit", nullable: false),
                    RoleID = table.Column<string>(type: "nvarchar(450)", nullable: false),
<<<<<<<< HEAD:MilkTeaBusinessObject/Migrations/20240603005437_v1.cs
                    DistrictID = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    DistrictID1 = table.Column<int>(type: "int", nullable: false)
========
                    DistrictID = table.Column<int>(type: "int", nullable: false)
>>>>>>>> H.Nam:MilkTeaBusinessObject/Migrations/20240531003217_v1.cs
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_User", x => x.UserID);
                    table.ForeignKey(
                        name: "FK_User_District_DistrictID1",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DetailsMaterial_MaterialID",
                table: "DetailsMaterial",
                column: "MaterialID");

            migrationBuilder.CreateIndex(
                name: "IX_DetailsMaterial_TeaID",
                table: "DetailsMaterial",
                column: "TeaID");
